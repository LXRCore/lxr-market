...
description 'LXRCore v3 market: the second-hand stalls — consignment listings, the broker cut, earnings on the shelf, listings that run out'
version '3.0.0'
repository 'https://github.com/LXRCore/lxr-market'
